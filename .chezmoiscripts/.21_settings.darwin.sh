...
# Set accent and highlight color
...
defaults write NSGlobalDomain AppleLanguages -array "en" "bn"
defaults write NSGlobalDomain AppleLocale -string "en_BD"
...
# Set machine sleep to x minutes
...
# update hammerspoon config location to ~/.config
...
# main source: https://mths.be/macos
